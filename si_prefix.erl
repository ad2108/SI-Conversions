...
% ----------------------------------------------------------------------- 
%! # Imports 
%! The module eunit is imported for unittesting this module. 
...
% ----------------------------------------------------------------------- 
%! ## to_deka 
%! The function to_deka converts all accesible formats to deka($10^1$) 
to_deka({tera, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_hecto 
%! The function to_hecto converts all accesible formats to hecto($10^2$) 
to_hecto({tera, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_kilo 
%! The function to_kilo converts all accesible formats to kilo($10^3$) 
to_kilo({tera, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_mega 
%! The function to_mega converts all accesible formats to mega($10^6$) 
to_mega({tera, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_giga 
%! The function to_giga converts all accesible formats to mega($10^9$) 
to_giga({tera, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_tera 
%! The function to_tera converts all accesible formats to tera($10^12$) 
to_tera({tera, N}) ->
  {tera, N};
to_tera({giga, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_deci 
%! The function to_deci converts all accesible formats to deci($10^-1$) 
to_deci({pico, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_centi 
%! The function to_centi converts all accesible formats to centi($10^-2$) 
to_centi({pico, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_mili 
%! The function to_mili converts all accesible formats to mili($10^-3$) 
to_mili({pico, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_micro 
%! The function to_mirco converts all accesible formats to micro($10^-6$) 
to_micro({pico, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_nano 
%! The function to_nano converts all accesible formats to nano($10^-9$) 
to_nano({pico, N}) ->
...
% ----------------------------------------------------------------------- 
%! ## to_pico 
%! The function to_pico converts all accesible formats to pico($10^-12$) 
to_pico({pico, N}) ->
  {pico, N};
to_pico({nano, N}) ->
